...
const db = new sqlite3.Database(dbPath, (err) => {
    ...
    `, (err, empleados) => {
        ...
        empleados.forEach(emp => {
            ...
            console.log(`🏢 Departamento: ${emp.departamento_nombre || 'Sin departamento'} (${emp.departamento_id})`);
        ...
        `, (err, stats) => {
            if (!err) {
                ...
                stats.forEach(stat => {
                    console.log(`   • ${stat.departamento || 'Sin departamento'}: ${stat.total} empleados`);
                });
            }
