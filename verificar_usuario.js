...
async function main() {
    try {
        ...
        if (!esValida) {
            ...
            console.log('1. Asegúrate de que la contraseña en la base de datos esté hasheada correctamente');
            console.log('2. Usa el siguiente comando para actualizar el hash:');
            console.log(`   node -e "const bcrypt = require('bcryptjs'); bcrypt.hash('${password}', 10).then(console.log);"`);
        }
